...
def Iterate(Letter, Number):
  ...
  if Letter == 123:
    Letter = Letter - 26
  Letter = chr(Letter)
  return(Iterate(Letter, Number - 1))
...
for Room in Input:
  ...
  # print(Name, "    ", CheckSum)
  AllLetters = [0 for x in range(26)]
  Name = Name.split("-")
  RoomID = Name[-1]
  Name = Name[:-1]
  for Letters in Name:
  ...
  for x in range(5):
    MaxIndex = -1
    MaxLetters = 0
    for Index in range(len(AllLetters)):
      if AllLetters[Index] > MaxLetters:
        MaxLetters = AllLetters[Index]
        MaxIndex = Index
    AllLetters[MaxIndex] = 0
    if MaxIndex == -1:
      Sum = "hellll nah"
      break
    Sum = Sum + chr(MaxIndex + 97)
  # print(Sum)
  if CheckSum == Sum:
    String = ""
    for Part in Name:
      for Index in range(len(Part)):
        Index = Part[Index]
        Index = Iterate(Index, int(RoomID))
        String = String + Index
      String = String + " "
    print(RoomID, String)
