Input = ["""...........................775.651...............887....79...946...921...493.....942..942.....151....155....................................
......240...................*.....-......................$..*...................*.......%.....+....................956.549.*290.......834...
...
def Search(Row, Column):
  if Input[Row][Column].isdigit() == False:
    return(0, [-1, -1])
  StartingOffset = 0
  List = [Input[Row][Column]]
  if Input[Row][Column - 1].isdigit():
    List = [Input[Row][Column - 1]] + List
    StartingOffset = -1
    if Input[Row][Column - 2].isdigit():
      List = [Input[Row][Column - 2]] + List
      StartingOffset = -2
  if Input[Row][Column + 1].isdigit():
    List = List + [Input[Row][Column + 1]]
    if Input[Row][Column + 2].isdigit():
      List = List + [Input[Row][Column + 2]]
  String = ""
  for x in List:
    String = String + x
  Number = int(String)
  return([Number, [Row, Column + StartingOffset]])
...
for ROW in range(len(Input)):
  for COLUMN in range(len(Input)):
    ThisList = []
    if isSymbol(Input[ROW][COLUMN]):
      if Input[ROW - 1][COLUMN - 1].isdigit():
        Placeholder = Search(ROW - 1, COLUMN - 1)
        if Placeholder[1] not in startList:
          startList.append(Placeholder[1])
          ThisList.append(Placeholder[0])
      if Input[ROW - 1][COLUMN].isdigit():
        Placeholder = Search(ROW - 1, COLUMN)
        if Placeholder[1] not in startList:
          startList.append(Placeholder[1])
          ThisList.append(Placeholder[0])
      if Input[ROW - 1][COLUMN + 1].isdigit():
      ...
      if Input[ROW + 1][COLUMN + 1].isdigit():
        ...
        if Placeholder[1] not in startList:
          ...
          ThisList.append(Placeholder[0])
      if Input[ROW][COLUMN - 1].isdigit():
        Placeholder = Search(ROW, COLUMN - 1)
        if Placeholder[1] not in startList:
          startList.append(Placeholder[1])
          ThisList.append(Placeholder[0])
      if Input[ROW][COLUMN + 1].isdigit():
        ...
        if Placeholder[1] not in startList:
          ...
          ThisList.append(Placeholder[0])
    if len(ThisList) == 2:
      Total += ThisList[0] * ThisList[1]
      print(Total, ThisList)
