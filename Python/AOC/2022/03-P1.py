...
for Rucksack in Input:
  Length = len(Rucksack)
  Length = int(Length/2)
  First = Rucksack[:Length]
  Second = Rucksack[Length:]
  Placeholder = Second
  Second = []
  for x in range(len(Placeholder)):
    Second.append(Placeholder[x])
  Common = ""
  ...
  if Common.islower():
    Total += ord(Common) - 96
    # print(Common, ord(Common) - 96)
  else:
    Total += ord(Common) - 65 + 26 + 1
    # print(Common, ord(Common) - 65 + 26 + 1)
