...
for Instruction in Input:
  if Instruction[:6] == "toggle":
    ...
    Row1 = Instruction[:Instruction.find(",")]
    Column1 = Instruction[Instruction.find(",") + 1:Instruction.find(" ")]
    Instruction = Instruction[Instruction.find("through") + 8:]
    Instruction = Instruction.split(",")
    Row2 = Instruction[0]
    Column2 = Instruction[1]
