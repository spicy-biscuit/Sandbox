...
for x in First:
  if x[0] == "R":
    for x in range(int(x[1:])):
      Counter += 1
      Column += 1
      SetA1.add((Row, Column, Counter))
      SetA2.add((Row, Column))
  elif x[0] == "L":
    for x in range(int(x[1:])):
      Counter += 1
      Column -= 1
...
for x in Second:
  if x[0] == "R":
    for x in range(int(x[1:])):
      Counter += 1
      Column += 1
      SetB1.add((Row, Column, Counter))
      SetB2.add((Row, Column))
  elif x[0] == "L":
    for x in range(int(x[1:])):
      Counter += 1
      Column -= 1
