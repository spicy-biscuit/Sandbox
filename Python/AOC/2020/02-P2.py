...
for x in Input:
  ...
  NumRequired = Requirements[0]
  NumRequired = NumRequired.split("-")
  LetterRequired = Requirements[1]
  NumRequired = [int(NumRequired[0]), int(NumRequired[1])]

  print(NumRequired, LetterRequired)
  print(Password)

  NumFound = 0
  for y in range(len(Password)):
    if Password[y] == LetterRequired:
      if y + 1 in NumRequired:
        NumFound += 1
